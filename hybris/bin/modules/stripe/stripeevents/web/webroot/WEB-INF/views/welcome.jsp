...
<html lang="en">
<head>
    <title>Welcome to stripeevents</title>
    <link rel="stylesheet" href="<c:url value="/static/stripeevents-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "stripeevents" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/stripeevents-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/stripeevents-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/stripeevents-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/stripeevents-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/stripeevents-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
